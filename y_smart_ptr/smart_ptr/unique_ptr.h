...
namespace _y {
    ...
    */
    ...
    public:
         ...
         * FIX ME!
         *
         * never use this explicitly,
         * it's to enable converting implicitly
         * like expression newPtr=move(otherPtr),
         * which converts _move<this_type> to const unique_ptr,
         * and then call operator=(const unique_ptr &cup) implicitly.
         *
         * so never use expression like newPtr=otherPtr,
         * where otherPtr defined before,
         * since it's incompatible with C++11.
         * use newPtr=move(otherPtr) instead.
         *
         * */
        unique_ptr &operator=(const unique_ptr &cup){
            unique_ptr &up=const_cast<unique_ptr&>(cup);
            swap(up);
        }
